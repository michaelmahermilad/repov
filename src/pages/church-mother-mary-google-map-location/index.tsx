...
function index() {
  ...
  return  (<>
        <p className='text-center text-[15px]   font-bold  my-7'>الموقع الجغرافي للكنيسة</p>

        <Image src={icon} alt='M' className='m-auto w-[130px] lg:w-[180px]   ' loading="lazy"/>

       <p className='text-center text-[14px] my-9'>:يمكنك زيارة الكنيسة في العنوان التالي</p>
      <p className='text-center text-[14px] my-8'>مصر - القاهرة - حدائق القبة  -المليحة  -شارع الكنيسة</p>
